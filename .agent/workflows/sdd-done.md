...
If currently inside a worktree (path contains `.worktrees/`), abort:
```
...
Worktree: .worktrees/feat-<ID>-<slug>
Branch: feat-<ID>-<slug>
Commits found: <N>
...
```bash
WORKTREE_PATH=".worktrees/feat-<FEAT-ID>-<slug>"
...
if [[ "$TYPE" != "hotfix" ]]; then
    ...
    TEMP_WORKTREE=".worktrees/_ledger-snapshot-$$"
...
```bash
git worktree remove .worktrees/feat-<FEAT-ID>-<slug>
```
...
Worktree removed: .worktrees/feat-<ID>-<slug>
