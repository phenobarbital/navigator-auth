...
class User(Model):
    ...
    registration_key: str = Column(required=False, max=512, repr=False)
    challenge_key: str = Column(required=False, max=512, repr=False)
    avatar: Text = Column(max=2048, repr=False)
    is_active: bool = Column(required=True, default=True)
    ...
    updated_at: datetime = Column(required=False, default=datetime.now(), repr=False)
